...
namespace CTRPluginFramework
{
    void PatchProcess(FwkSettings &Settings)
    {
        ...
        Color Selected = Selected.Blend(Color(0xFF1A697F), Color::BlendMode::Alpha).Fade(.1f); 
		Settings.Keyboard.Background = Color(0x2E2F35FF);
		Settings.Keyboard.KeyBackground = Color(0x2E2F35FF); Color(0x4F1F39FF);
        Settings.Keyboard.KeyBackgroundPressed = Selected;
		...
		Settings.CustomKeyboard.KeyBackgroundPressed = Selected;
